...
export const endpoints = makeApi([
	...
	},
	{
		...
		response: z.object({ userIri: z.string(), userId: z.string(), family_name: z.string(), given_name: z.string(), is_active: z.boolean(), in_projects: z.array(z.object({ project: z.string(), permissions: z.array(z.string()) }).partial().passthrough()), has_permissions: z.array(z.string()) }).partial().passthrough(),
		errors: [
			{
				status: 403,
				description: `Unauthorized`,
